 ...
 */
function initStandalone$1(app, url, version, nodeAdmin) {
...
function registerDatabase(instance) {
    ...
    if (util.isNodeSdk()) {
        module.exports = Object.assign({}, namespace, { initStandalone: initStandalone$1 });
    }
}
try {
    ...
    var firebase = require('@firebase/app').default; // Only present for v8, undefined for v9 (should skip).
    if (firebase) {
...
exports.DataSnapshot = DataSnapshot$1;
exports.Database = Database;
exports.OnDisconnect = OnDisconnect$1;
exports.Query = Query;
exports.Reference = Reference;
exports.ServerValue = ServerValue;
exports.enableLogging = enableLogging$1;
exports.initStandalone = initStandalone$1;
