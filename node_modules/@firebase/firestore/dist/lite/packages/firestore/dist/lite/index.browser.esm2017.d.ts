...
declare function br(t: any, e: any, n: any): Promise<void>;
/**
...
export { _n as Bytes, hn as CollectionReference, cn as DocumentReference, Gn as DocumentSnapshot, pn as FieldPath, gn as FieldValue, nn as FirebaseFirestore, U as FirestoreError, vn as GeoPoint, an as Query, Zn as QueryConstraint, Hn as QueryDocumentSnapshot, Yn as QuerySnapshot, yt as Timestamp, Lr as Transaction, Dr as WriteBatch, Ir as addDoc, Vr as arrayRemove, Rr as arrayUnion, ln as collection, fn as collectionGroup, Tr as deleteDoc, Ar as deleteField, dn as doc, yn as documentId, fr as endAt, lr as endBefore, gr as getDoc, vr as getDocs, sn as getFirestore, Nr as increment, rn as initializeFirestore, ir as limit, or as limitToLast, rr as orderBy, Xn as query, mn as queryEqual, wn as refEqual, Ur as runTransaction, Pr as serverTimestamp, br as setDoc, w as setLogLevel, Kn as snapshotEqual, ar as startAfter, cr as startAt, un as terminate, Er as updateDoc, on as useFirestoreEmulator, er as where, Fr as writeBatch };
