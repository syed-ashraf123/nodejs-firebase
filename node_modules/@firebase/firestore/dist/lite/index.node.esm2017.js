...
function runTransaction(firestore, updateFunction) {
    ...
    new TransactionRunner(newAsyncQueue(), datastore, internalTransaction => updateFunction(new Transaction$1(firestore, internalTransaction)), deferred).run();
...
export { Bytes, CollectionReference, DocumentReference, DocumentSnapshot, FieldPath$1 as FieldPath, FieldValue, FirebaseFirestore, FirestoreError, GeoPoint, Query, QueryConstraint, QueryDocumentSnapshot, QuerySnapshot, Timestamp, Transaction$1 as Transaction, WriteBatch, addDoc, arrayRemove, arrayUnion, collection, collectionGroup, deleteDoc, deleteField, doc, documentId, endAt, endBefore, getDoc, getDocs, getFirestore, increment, initializeFirestore, limit, limitToLast, orderBy, query, queryEqual, refEqual, runTransaction, serverTimestamp, setDoc, setLogLevel, snapshotEqual, startAfter, startAt, terminate, updateDoc, useFirestoreEmulator, where, writeBatch };
