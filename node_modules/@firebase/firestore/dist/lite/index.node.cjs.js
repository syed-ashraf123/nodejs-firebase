...
function fieldPathFromDotSeparatedString(methodName, path, targetDoc) {
    ...
    try {
        return new (FieldPath$1.bind.apply(FieldPath$1, tslib.__spreadArray([void 0], path.split('.'))))()._internalPath;
    }
    catch (e) {
...
var Transaction = /** @class */ (function () {
    ...
    Transaction.prototype.write = function (mutation) {
        this.ensureCommitNotCalled();
...
var AsyncQueueImpl = /** @class */ (function () {
    ...
    AsyncQueueImpl.prototype.enterRestrictedMode = function () {
...
function runTransaction(firestore, updateFunction) {
    ...
    new TransactionRunner(newAsyncQueue(), datastore, function (internalTransaction) { return updateFunction(new Transaction$1(firestore, internalTransaction)); }, deferred).run();
