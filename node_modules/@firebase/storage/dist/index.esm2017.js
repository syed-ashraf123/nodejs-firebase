...
class ReferenceCompat {
     ...
     */
    child(childPath) {
        const reference = _getChild$1(this._delegate, childPath);
     ...
     */
    listAll() {
        return listAll$1(this._delegate).then(r => new ListResultCompat(r, this.storage));
    }
    /**
     * List items (files) and prefixes (folders) under this storage reference.
     *
     ...
     */
    list(options) {
        return list$2(this._delegate, options || undefined).then(r => new ListResultCompat(r, this.storage));
    }
    /**
     * A promise that resolves with the metadata for this object. If this
     * object doesn't exist or metadata cannot be retreived, the promise is
...
function factory(container, { instanceIdentifier: url }) {
    ...
    const storageServiceCompat = new StorageServiceCompat(app, new StorageService(app, authProvider, appCheckProvider, new XhrIoPool(), url, firebase.SDK_VERSION));
