...
function factory(container, _a) {
    ...
    var storageServiceCompat = new StorageServiceCompat(app, new StorageService(app, authProvider, appCheckProvider, new XhrIoPool(), url, firebase__default['default'].SDK_VERSION));
    return storageServiceCompat;
}
